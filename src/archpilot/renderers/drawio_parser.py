...
_STYLE_PATTERNS: list[tuple[str, ComponentType]] = [
    ...
    # GCP 서비스 심볼
    ("gcp2.compute_engine",          ComponentType.SERVER),
    ("gcp2.cloud_sql",               ComponentType.DATABASE),
    ("gcp2.cloud_spanner",           ComponentType.DATABASE),
    ("gcp2.cloud_bigtable",          ComponentType.DATABASE),
    ("gcp2.cloud_storage",           ComponentType.STORAGE),
    ("gcp2.persistent_disk",         ComponentType.STORAGE),
    ("gcp2.pub_sub",                 ComponentType.QUEUE),
    ("gcp2.memorystore",             ComponentType.CACHE),
    ("gcp2.cloud_cdn",               ComponentType.CDN),
    ("gcp2.cloud_load_balancing",    ComponentType.LOADBALANCER),
    ("gcp2.api_gateway",             ComponentType.GATEWAY),
    ("gcp2.cloud_endpoints",         ComponentType.GATEWAY),
    ("gcp2.cloud_run",               ComponentType.SERVICE),
    ("gcp2.kubernetes_engine",       ComponentType.SERVICE),
    ("gcp2.cloud_functions",         ComponentType.SERVICE),
    ("gcp2.app_engine",              ComponentType.SERVICE),
    ("gcp2.cloud_armor",             ComponentType.SECURITY),
    ("gcp2.cloud_monitoring",        ComponentType.MONITORING),
    # Azure 서비스 심볼
    ("azure.virtual_machine",        ComponentType.SERVER),
    ("azure.sql_database",           ComponentType.DATABASE),
    ("azure.cosmos_db",              ComponentType.DATABASE),
    ("azure.storage",                ComponentType.STORAGE),
    ("azure.blob_storage",           ComponentType.STORAGE),
    ("azure.service_bus",            ComponentType.QUEUE),
    ("azure.event_hubs",             ComponentType.QUEUE),
    ("azure.redis_cache",            ComponentType.CACHE),
    ("azure.cdn",                    ComponentType.CDN),
    ("azure.load_balancer",          ComponentType.LOADBALANCER),
    ("azure.application_gateway",    ComponentType.LOADBALANCER),
    ("azure.api_management",         ComponentType.GATEWAY),
    ("azure.app_service",            ComponentType.SERVICE),
    ("azure.functions",              ComponentType.SERVICE),
    ("azure.kubernetes_service",     ComponentType.SERVICE),
    ("azure.container_instances",    ComponentType.SERVICE),
    ("azure.key_vault",              ComponentType.SECURITY),
    ("azure.active_directory",       ComponentType.SECURITY),
    ("azure.monitor",                ComponentType.MONITORING),
    # Kubernetes 리소스 심볼
    ("kubernetes.pod",               ComponentType.SERVICE),
    ("kubernetes.deploy",            ComponentType.SERVICE),
    ("kubernetes.rs",                ComponentType.SERVICE),
    ("kubernetes.svc",               ComponentType.GATEWAY),
    ("kubernetes.ing",               ComponentType.GATEWAY),
    ("kubernetes.pv",                ComponentType.STORAGE),
    ("kubernetes.cm",                ComponentType.SERVICE),
